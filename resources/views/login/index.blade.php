...
<head>
    ...
    <link href="{{ url('css/materialize/materialize.min.css') }}" type="text/css" rel="stylesheet" media="screen,projection">
    <link href="{{ url('css/materialize/style.min.css') }}" type="text/css" rel="stylesheet" media="screen,projection">
    <!-- Custome CSS-->
    <link href="css/custom/custom-style.css" type="text/css" rel="stylesheet" media="screen,projection">
    <link href="{{ url('css/materialize/page-center.css') }}" type="text/css" rel="stylesheet" media="screen,projection">
        ...
        <form class="login-form" method="post" action="{{ url('login') }}">
            <div class="row">
                <div class="input-field col s12 center">
                    <img src="{{ url('images/login-logo.png') }}" alt="" class="circle responsive-img valign profile-image-login">
